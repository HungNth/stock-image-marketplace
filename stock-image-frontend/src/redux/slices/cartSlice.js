...
export const cartSlice = createSlice({
    ...
    reducers: {
        addToCart(state, action) {
            ...
            // check if the picture already exists in the cart
            // if exists, we tell the user that the picture is already in the cart
            // if not, we add the picture to the cart
            if (exists) {
                toast.info('Picture already exists in your cart', {
                    position: 'top-right',
                });
            } else {
